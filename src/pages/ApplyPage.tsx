...
import { registerTherapist } from '../services/auth/auth.api';
import QuestionnaireForm from './RegisterPage/QuestionnaireForm';
...
const ApplyPage: React.FC = () => {
  ...
  // Fetch therapist registration questionnaires (public endpoint)
  const { data: questionnaires, isLoading: loadingQuestionnaires } =
    useRegistrationQuestionnaires('therapist');
  ...
  const handleAccountSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Register therapist (only account fields, NOT answers)
      const authResponse = await registerTherapist({
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-tertiary-700">Loading...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <h2 className="mt-6 text-center text-3xl font-extrabold text-tertiary-900">
            Apply as a Therapist
          </h2>
          <p className="mt-2 text-center text-sm text-tertiary-700">
            Create your therapist account to start helping clients.{' '}
            <Link
              to="/login"
          ...
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <form className="space-y-6" onSubmit={handleAccountSubmit}>
              <div>
                <label
                  htmlFor="full-name"
                  className="block text-sm font-medium text-tertiary-800"
                >
                  Full name
                </label>
                <div className="mt-1">
              ...
              <div className="flex items-center">
                ...
                <label
                  htmlFor="agree-terms"
                  className="ml-2 block text-sm text-tertiary-900"
                >
                  I agree to the{' '}
                  <a
                    href="#"
              ...
              <div>
                ...
                >
                  {isSubmitting ? 'Creating account...' : 'Apply as Therapist'}
                </button>
              </div>
            </form>
          </div>
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 text-center">
            ...
            <h2 className="text-2xl font-bold text-tertiary-900 mb-4">
              Application Submitted!
            </h2>
            <p className="text-tertiary-700 mb-8">
              Your therapist application has been submitted successfully. We'll
